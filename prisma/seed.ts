...
async function main() {
  console.log("🌱 Seeding Chainviax database...");
  ...
  const admin = await prisma.user.upsert({
    where: { email: "admin@chainviax.com" },
    update: {},
    create: {
      email: "admin@chainviax.com",
      name: "Chainviax Admin",
      password: adminPwd,
      role: "ADMIN",
      status: "ACTIVE",
      profile: { create: { firstName: "Chainviax", lastName: "Admin", country: "United States" } },
      wallets: { create: [
  ...
  await prisma.notification.createMany({
    data: [
      { userId: user1.id, title: "Welcome to Chainviax", message: "Your account has been created.", type: "INFO", isRead: true },
      ...
      { userId: user2.id, title: "Welcome to Chainviax", message: "Complete verification to unlock all features.", type: "INFO", isRead: false },
  ...
  console.log("\n🎉 Seed complete!\n");
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("🔐 Admin:  admin@chainviax.com  /  Admin@123456");
