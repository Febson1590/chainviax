    ...
    email: user?.email
      ? {
          ...
          subject: action === "APPROVE"
            ? "Your Chainviax deposit has been approved"
            : "Update on your Chainviax deposit request",
  ...
  await notifyUser({
    ...
    email: user?.email
      ? {
          ...
          name: user.name || "Trader",
          subject: action === "APPROVE"
            ? "Your Chainviax withdrawal has been approved"
            : "Update on your Chainviax withdrawal request",
  ...
  await notifyUser({
    ...
    email: user?.email
      ? {
          ...
          name: user.name || "Trader",
          subject: action === "APPROVE"
            ? "Your Chainviax identity has been verified"
            : "Update on your Chainviax verification",
          heading: action === "APPROVE" ? "Identity Verified" : "Verification Update",
          body: action === "APPROVE"
            ? [
                "Your identity has been verified successfully.",
                "You now have full access to all trading and investment features on Chainviax.",
              ]
            : [
