...
const faqs = [
  {
    q: "How do I open a Chainviax account?",
  ...
  {
    q: "Is Chainviax available in my country?",
    a: "Chainviax is available in most jurisdictions worldwide. Some countries may be restricted due to local regulation. Your region is checked during onboarding.",
  },
  {
