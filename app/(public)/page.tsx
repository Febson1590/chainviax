...
const featuredIn = ["Forbes", "Bloomberg", "Yahoo", "Coindesk", "CNBC"];
        ...
        <div className="max-w-7xl mx-auto w-full relative">
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.35fr)] gap-8 lg:gap-10 items-start">
            ...
            <div className="pt-6 lg:pt-10 min-w-0 w-full">
              ...
              <Link
                href="/markets"
                className="group inline-flex items-center gap-2 px-3 py-1.5 mb-4 rounded-full text-[11px] font-semibold text-amber-100 tabular-nums"
                style={{
                  background: "rgba(234, 179, 8, 0.08)",
                  border: "1px solid rgba(250, 204, 21, 0.28)",
                  boxShadow: "inset 0 1px 0 rgba(255,255,255,0.04), 0 0 0 3px rgba(234, 179, 8,0.05)",
                }}
              >
                <span className="inline-flex items-center gap-1 px-1.5 py-[1px] rounded-full bg-amber-500/25 text-amber-50 text-[9px] font-black tracking-wider">
              ...
              <h1 className="text-[38px] sm:text-[46px] lg:text-[56px] font-bold text-white leading-[1.04] tracking-tight mb-4">
                Your Premium
                <br />
                <span className="gradient-text">Crypto Broker.</span>
              </h1>

              <p className="text-[14px] sm:text-[15px] text-slate-400 max-w-lg mb-5 leading-relaxed">
                Trade Bitcoin, Ethereum, and the top cryptocurrencies with institution-grade
                security and deep liquidity. Built for serious traders — clean execution,
                transparent fees, and strong account controls.
              </p>

              <div className="flex flex-col sm:flex-row gap-2.5 mb-7">
                <Link
                  href="/register"
                  className="vx-btn-primary inline-flex items-center justify-center gap-2 h-12 px-7 rounded-lg text-[14px] font-bold"
                >
                  Get Started <ArrowRight className="h-4 w-4" />
                </Link>
                <Link
                  href="/markets"
                  className="vx-btn-ghost inline-flex items-center justify-center gap-2 h-12 px-7 rounded-lg text-[14px]"
                >
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[11px] text-slate-500 mb-7">
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 size={12} className="text-amber-400" /> Institution-grade liquidity</span>
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 size={12} className="text-amber-400" /> Email OTP login</span>
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 size={12} className="text-amber-400" /> Manual KYC review</span>
                <span className="inline-flex items-center gap-1.5"><CheckCircle2 size={12} className="text-amber-400" /> 24/7 monitoring</span>
              </div>
            ...
            <div className="relative min-w-0 w-full space-y-4">
              ...
              >
                <div
                  ...
                  style={{ background: "radial-gradient(ellipse, rgba(234, 179, 8,0.14) 0%, transparent 65%)" }}
                />
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
            {marqueeFeatures.map((f) => (
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(234, 179, 8,0.06) 0%, rgba(4,12,24,0.6) 55%)",
                }}
              >
                <div
                  aria-hidden="true"
          ...
          <div className="grid lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] gap-12 items-start">
            <div>
              ...
              <h2 className="text-[26px] sm:text-[32px] font-bold text-white tracking-tight leading-[1.1] mb-4">
                Why traders{" "}
                <span className="gradient-text">trust Chainviax.</span>
              </h2>
              ...
              >
                ...
                <svg viewBox="0 0 120 36" className="absolute right-3 top-3 w-[70px] h-[22px] opacity-60">
                  ...
                  <path
                    ...
                    stroke="#facc15" strokeWidth="1.4" fill="none" strokeLinecap="round"
                  />
                  <path
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl mb-10">
            ...
            <h2 className="text-[26px] sm:text-[32px] font-bold text-white tracking-tight leading-[1.1]">
              Traders who{" "}
              <span className="gradient-text">rely on Chainviax.</span>
            </h2>
            <p className="text-[13px] text-slate-400 mt-3 leading-relaxed">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div
            ...
            style={{ background: "radial-gradient(ellipse, rgba(234, 179, 8,0.22) 0%, rgba(253, 224, 71,0.10) 35%, transparent 65%)" }}
          />
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 0 0 1px rgba(234, 179, 8,0.08), 0 50px 120px rgba(0,0,0,0.7), inset 0 1px 0 rgba(255,255,255,0.06), inset 0 0 60px rgba(234, 179, 8,0.025)",
            }}
          >
          ...
          <div className="relative h-[280px] sm:h-[320px] vx-grid-bg" style={{ background: "linear-gradient(180deg, rgba(3,10,22,0.45) 0%, rgba(2,8,18,0.9) 100%)" }}>
            <svg viewBox="0 0 500 300" preserveAspectRatio="none" className="w-full h-full">
              ...
              <path
                ...
                stroke="#facc15" strokeWidth="1.6" fill="none" strokeLinecap="round" opacity="0.55"
              />
              <path
              ...
              />
              <circle cx="500" cy="22" r="3" fill="#facc15" />
              <circle cx="500" cy="22" r="7" fill="#facc15" fillOpacity="0.2" />
            </svg>
