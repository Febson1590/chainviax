      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6 text-sm text-slate-400 leading-relaxed">
          <section>
            ...
            <p>
              By creating a Chainviax account or using any part of the platform, you agree to be
          ...
          <section>
            ...
            <p>
              ...
              to keep it updated. Chainviax may require identity verification (KYC) before unlocking
          ...
          <section>
            ...
            <p>
              Trades executed on Chainviax are final once confirmed. Prices and market data are
          ...
          <section>
            ...
            <p>
              ...
              vary based on method, compliance checks, and network conditions. Chainviax is not
          ...
          <section>
            ...
            <p>
              You agree not to use Chainviax for any unlawful activity, including money laundering,
          ...
          <section>
            ...
            <p>
              Chainviax is provided on an &ldquo;as is&rdquo; and &ldquo;as available&rdquo; basis. To the
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:support@chainviax.com" className="text-sky-400 hover:text-sky-300">
                support@chainviax.com
              </a>.
            </p>
          </section>
        </div>
