      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6 text-sm text-slate-400 leading-relaxed">
          <section>
            ...
            <p className="mb-2">
              When you create a Chainviax account and use the platform, we collect the following
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:privacy@chainviax.com" className="text-sky-400 hover:text-sky-300">
                privacy@chainviax.com
              </a>.
            </p>
          </section>
        </div>
