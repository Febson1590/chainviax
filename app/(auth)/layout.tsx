  ...
  return (
    ...
    >
      ...
      <svg
        ...
        aria-hidden="true"
      >
        <g opacity="0.055" stroke="#fef08a" strokeWidth="0.65" fill="none">
          {/* Meridians */}
      ...
      >
        ...
        {([100,200,300,400,500,600,700,800] as number[]).map(y => (
          <line key={y} x1={0} y1={y} x2={760} y2={y} stroke="#facc15" strokeWidth="0.5" opacity="0.35" />
        ))}
        {/* Candles */}
        ...
        <path
          ...
          stroke="#facc15" strokeWidth="1.5" fill="none" opacity="0.55"
        />
      </svg>
      ...
      <svg
        ...
        aria-hidden="true"
      >
        <g opacity="0.065" stroke="#facc15" fill="none">
      ...
      <svg
        ...
        aria-hidden="true"
      >
        <g opacity="0.2" fill="#fef08a">
          {DOTS.map(([cx, cy, r], i) => (
            <circle key={i} cx={cx} cy={cy} r={r} />
          ))}
        </g>
        <g opacity="0.055" stroke="#fef08a" strokeWidth="0.55">
      ...
      <div className="relative z-10 p-6 text-center">
        <p className="text-xs text-slate-600">
          © {new Date().getFullYear()} Chainviax · All rights reserved · TLS Secured · KYC Verified
        </p>
      </div>
