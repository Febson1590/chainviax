...
export const metadata: Metadata = { title: "Investment Plans — Chainviax" };
...
export default async function InvestmentsPage() {
  ...
  const plans = plansRaw.map((p) => ({
    ...
    minDurationHours: p.minDurationHours != null ? Number(p.minDurationHours) : null,
    maxDurationHours: p.maxDurationHours != null ? Number(p.maxDurationHours) : null,
