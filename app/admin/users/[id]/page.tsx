        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
          {CURRENCIES.map(c => (
            <button
              ...
              className={`rounded-xl p-3.5 border text-left transition-all ${selCurrency === c ? "border-sky-500/60 bg-sky-500/10 shadow-[0_0_0_1px_rgba(234, 179, 8,0.2)]" : "border-white/[0.08] bg-white/[0.03] hover:bg-white/[0.06]"}`}
            >
